...
(0, vitest_1.describe)('Nuxt-4', () => {
    const projectDir = path.resolve(__dirname, '../test-applications/nuxt-4-test-app');
...
async function runWizardOnNuxtProject(projectDir) {
    ...
    const deploymentPlatformPrompted = nftOverridePrompted &&
        (await wizardInstance.sendStdinAndWaitForOutput(utils_2.KEYS.ENTER, 'Please select your deployment platform.', {
            timeout: 240000,
        }));
    ...
    await wizardInstance.sendStdinAndWaitForOutput([utils_2.KEYS.ENTER, utils_2.KEYS.ENTER], 'Successfully installed the Sentry Nuxt SDK!');
    wizardInstance.kill();
}
